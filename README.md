...
# What is Better Big Screen Window Manager++?
...
I quickly got tired & annoyed at chasing new windows which would pop up in the far upper left corner of the screen. *Windows itself is quite bad opening up there.* It was something I never gave never gave much thought to on a 32in 1080p monitor but with this much screen chasing windows **with the mouse** all over the place got old fast!
...
> [!ATTENTION] Why does a simple window manager script ask for Admin Control?
...
> [!ATTENTION] **Some of these Hotkeys might conflict Window pre-set System Hotkeys**
> 
